...
import DevPreView from 'Comp/Testing/Develop/DevPreView'
import { DeleteTest } from 'Comp/Testing/Develop/DeleteTest'
import EditorTest from 'Comp/Testing/NewDevelop/Editor'
...
class DevelopList extends Component {
	...
	render() {
		...
		if (list === 0 ) return (
			<EditorTest onCloseEditor={this.onCloseEditor} />
		)
		else return (
